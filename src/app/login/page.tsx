      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-[#12121a] border border-[#2a2a3e] rounded-2xl p-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 bg-[#0a0a0f] border border-[#2a2a3e] rounded-xl px-4 py-3 text-white hover:bg-[#1a1a2e] transition-colors">
            ...
            <button className="flex items-center justify-center gap-2 bg-[#5865F2] rounded-xl px-4 py-3 text-white hover:bg-[#4752C4] transition-colors">
